...
const nameEl = document.querySelector('.form-container .form-row input[name="empid"]');
const emailEl = document.querySelector('.form-container .form-row input[name="emppass"]');
